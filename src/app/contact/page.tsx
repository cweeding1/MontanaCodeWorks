          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow-lg p-8">
              ...
              <div className="flex space-x-4">
                ...
                <a href="#" className="w-12 h-12 bg-pink-500 text-white rounded-lg flex items-center justify-center hover:bg-pink-600 transition-colors">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
          ...
          <div className="bg-gray-200 rounded-lg h-64 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-400">Replace with Google Maps or your preferred map service</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 mb-16">
          ...
          <div className="space-y-6">
            ...
            <div className="border-b border-gray-200 pb-6">
              ...
              <p className="text-gray-600">Yes! We provide ongoing support and maintenance packages to keep your website secure, updated, and running smoothly. Support packages are available at different levels to meet your needs.</p>
            </div>
            <div className="border-b border-gray-200 pb-6">
