      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">
            Welcome to Your
            <span className="block text-blue-600">Amazing Website</span>
          </h1>
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Discover amazing content and explore everything we have to offer. 
            Your journey starts here with our incredible platform.
          </p>
        ...
        <div className="bg-blue-600 rounded-2xl p-8 text-center text-white">
          ...
          <p className="text-xl text-blue-100 mb-6">Join thousands of satisfied users today.</p>
